be_define_const_str(, "", 2166136261u, 0, 0, &be_const_str_chdir);
be_define_const_str(_X21_X3D, "!=", 2428715011u, 0, 2, NULL);
be_define_const_str(_X28_X29, "()", 685372826u, 0, 2, &be_const_str_attrdump);
be_define_const_str(_X2B, "+", 772578730u, 0, 1, &be_const_str__X2Esize);
be_define_const_str(_X2E_X2E, "..", 2748622605u, 0, 2, &be_const_str_else);
be_define_const_str(_X2Elen, ".len", 850842136u, 0, 4, &be_const_str_searchall);
be_define_const_str(_X2Ep, ".p", 1171526419u, 0, 2, NULL);
be_define_const_str(_X2Esize, ".size", 1965188224u, 0, 5, &be_const_str_setmember);
be_define_const_str(_X3D_X3D, "==", 2431966415u, 0, 2, NULL);
be_define_const_str(__incr__, "__incr__", 3240913791u, 0, 8, &be_const_str_classof);
be_define_const_str(__iterator__, "__iterator__", 3884039703u, 0, 12, &be_const_str_isnan);
...
be_define_const_str(_buffer, "_buffer", 2044888568u, 0, 7, &be_const_str_isfile);
be_define_const_str(_change_buffer, "_change_buffer", 2101848693u, 0, 14, &be_const_str_init);
be_define_const_str(_p, "_p", 1594591802u, 0, 2, NULL);
be_define_const_str(abs, "abs", 709362235u, 0, 3, &be_const_str_import);
be_define_const_str(acos, "acos", 1006755615u, 0, 4, &be_const_str_asin);
be_define_const_str(add, "add", 993596020u, 0, 3, &be_const_str_find);
be_define_const_str(allocated, "allocated", 429986098u, 0, 9, &be_const_str_re_pattern);
be_define_const_str(allocs, "allocs", 1254752255u, 0, 6, &be_const_str_counters);
be_define_const_str(as, "as", 1579491469u, 67, 2, &be_const_str_exists);
be_define_const_str(asin, "asin", 4272848550u, 0, 4, NULL);
be_define_const_str(assert, "assert", 2774883451u, 0, 6, &be_const_str_class);
be_define_const_str(asstring, "asstring", 1298225088u, 0, 8, &be_const_str_pop);
be_define_const_str(atan, "atan", 108579519u, 0, 4, &be_const_str_list);
be_define_const_str(atan2, "atan2", 3173440503u, 0, 5, &be_const_str_count);
be_define_const_str(attrdump, "attrdump", 1521571304u, 0, 8, &be_const_str_int);
be_define_const_str(bool, "bool", 3365180733u, 0, 4, &be_const_str_char);
be_define_const_str(break, "break", 3378807160u, 58, 5, &be_const_str_ismethod);
be_define_const_str(byte, "byte", 1683620383u, 0, 4, &be_const_str_deinit);
be_define_const_str(bytes, "bytes", 1706151940u, 0, 5, &be_const_str_call);
be_define_const_str(call, "call", 3018949801u, 0, 4, &be_const_str_ismapped);
...
be_define_const_str(chdir, "chdir", 806634853u, 0, 5, &be_const_str_classname);
be_define_const_str(class, "class", 2872970239u, 57, 5, &be_const_str_rand);
be_define_const_str(classname, "classname", 1998589948u, 0, 9, &be_const_str_has);
be_define_const_str(classof, "classof", 1796577762u, 0, 7, &be_const_str_cos);
be_define_const_str(clear, "clear", 1550717474u, 0, 5, &be_const_str_return);
be_define_const_str(clock, "clock", 363073373u, 0, 5, &be_const_str_dump);
be_define_const_str(codedump, "codedump", 1786337906u, 0, 8, &be_const_str_range);
be_define_const_str(collect, "collect", 2399039025u, 0, 7, &be_const_str_input);
be_define_const_str(compile, "compile", 1000265118u, 0, 7, &be_const_str_map);
be_define_const_str(concat, "concat", 4124019837u, 0, 6, &be_const_str_mkdir);
be_define_const_str(contains, "contains", 1825239352u, 0, 8, &be_const_str_imax);
be_define_const_str(continue, "continue", 2977070660u, 59, 8, &be_const_str_format);
be_define_const_str(copy, "copy", 3848464964u, 0, 4, &be_const_str_setrange);
...
be_define_const_str(counters, "counters", 4095866864u, 0, 8, &be_const_str_exp);
be_define_const_str(def, "def", 3310976652u, 55, 3, &be_const_str_floor);
...
be_define_const_str(end, "end", 1787721130u, 56, 3, &be_const_str_static);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_setfloat);
be_define_const_str(except, "except", 950914032u, 69, 6, &be_const_str_imin);
be_define_const_str(exists, "exists", 1002329533u, 0, 6, &be_const_str_getfloat);
be_define_const_str(exit, "exit", 3454868101u, 0, 4, &be_const_str_if);
be_define_const_str(exp, "exp", 1923516200u, 0, 3, &be_const_str_setmodule);
be_define_const_str(false, "false", 184981848u, 62, 5, NULL);
be_define_const_str(find, "find", 3186656602u, 0, 4, &be_const_str_setbits);
be_define_const_str(floor, "floor", 3102149661u, 0, 5, &be_const_str_isdir);
be_define_const_str(for, "for", 2901640080u, 54, 3, NULL);
be_define_const_str(format, "format", 3114108242u, 0, 6, &be_const_str_tob64);
be_define_const_str(frees, "frees", 2655040120u, 0, 5, &be_const_str_isinstance);
be_define_const_str(fromb64, "fromb64", 2717019639u, 0, 7, &be_const_str_module);
be_define_const_str(fromhex, "fromhex", 1847150394u, 0, 7, &be_const_str_geti);
be_define_const_str(fromptr, "fromptr", 666189689u, 0, 7, &be_const_str_reallocs);
be_define_const_str(fromstring, "fromstring", 610302344u, 0, 10, &be_const_str_setitem);
be_define_const_str(gcdebug, "gcdebug", 227911486u, 0, 7, &be_const_str_top);
be_define_const_str(get, "get", 1410115415u, 0, 3, NULL);
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, &be_const_str_hex);
be_define_const_str(getcwd, "getcwd", 652026575u, 0, 6, NULL);
be_define_const_str(getfloat, "getfloat", 2820979603u, 0, 8, &be_const_str_while);
...
be_define_const_str(hex, "hex", 4273249610u, 0, 3, &be_const_str_sinh);
be_define_const_str(if, "if", 959999494u, 50, 2, &be_const_str_tr);
be_define_const_str(imax, "imax", 3084515410u, 0, 4, &be_const_str_iter);
be_define_const_str(imin, "imin", 2714127864u, 0, 4, &be_const_str_log10);
be_define_const_str(import, "import", 288002260u, 66, 6, &be_const_str_rad);
be_define_const_str(incr, "incr", 482404207u, 0, 4, &be_const_str_item);
be_define_const_str(init, "init", 380752755u, 0, 4, &be_const_str_print);
be_define_const_str(input, "input", 4191711099u, 0, 5, NULL);
be_define_const_str(insert, "insert", 3332609576u, 0, 6, &be_const_str_length_X20in_X20bits_X20must_X20be_X20between_X200_X20and_X2032);
be_define_const_str(int, "int", 2515107422u, 0, 3, &be_const_str_pow);
be_define_const_str(isdir, "isdir", 2340917412u, 0, 5, &be_const_str_issubclass);
be_define_const_str(isfile, "isfile", 3131505107u, 0, 6, &be_const_str_tohex);
be_define_const_str(isinstance, "isinstance", 3669352738u, 0, 10, &be_const_str_match2);
be_define_const_str(ismapped, "ismapped", 2725004770u, 0, 8, &be_const_str_resize);
be_define_const_str(ismethod, "ismethod", 3513438880u, 0, 8, NULL);
be_define_const_str(isnan, "isnan", 2981347434u, 0, 5, &be_const_str_true);
be_define_const_str(issubclass, "issubclass", 4078395519u, 0, 10, NULL);
be_define_const_str(item, "item", 2671260646u, 0, 4, &be_const_str_member);
...
be_define_const_str(listdir, "listdir", 2005220720u, 0, 7, &be_const_str_time);
be_define_const_str(load, "load", 3859241449u, 0, 4, &be_const_str_setbytes);
...
be_define_const_str(lower, "lower", 3038577850u, 0, 5, &be_const_str_traceback);
be_define_const_str(map, "map", 3751997361u, 0, 3, &be_const_str_members);
be_define_const_str(match, "match", 2116038550u, 0, 5, &be_const_str_search);
be_define_const_str(match2, "match2", 816512812u, 0, 6, &be_const_str_real);
be_define_const_str(matchall, "matchall", 1385990901u, 0, 8, &be_const_str_number);
...
be_define_const_str(module, "module", 3617558685u, 0, 6, &be_const_str_tobool);
...
be_define_const_str(open, "open", 3546203337u, 0, 4, &be_const_str_size);
be_define_const_str(path, "path", 2223459638u, 0, 4, NULL);
be_define_const_str(pi, "pi", 1213090802u, 0, 2, &be_const_str_var);
be_define_const_str(pop, "pop", 1362321360u, 0, 3, &be_const_str_upper);
...
be_define_const_str(raise, "raise", 1593437475u, 70, 5, &be_const_str_split);
be_define_const_str(rand, "rand", 2711325910u, 0, 4, &be_const_str_reverse);
...
be_define_const_str(remove, "remove", 3683784189u, 0, 6, &be_const_str_toupper);
be_define_const_str(replace, "replace", 2704835779u, 0, 7, &be_const_str_value_error);
...
be_define_const_str(search, "search", 2150836393u, 0, 6, &be_const_str_solidified);
...
be_define_const_str(setbytes, "setbytes", 197507254u, 0, 8, &be_const_str_super);
...
be_define_const_str(setrange, "setrange", 3794019032u, 0, 8, &be_const_str_system);
...
be_define_const_str(str, "str", 3259748752u, 0, 3, &be_const_str_tostring);
...
static const bstring* const m_string_table[] = {
    ...
    (const bstring *)&be_const_str_replace,
